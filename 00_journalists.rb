...
def w_number (array)
  restult_number = array.select {|item| item =~ /[0-9]/}
...
def w_aude (array)
  result_aude = array.select {|item| item.include?("aude")}
...
def start_w_capital (array)
  ...
  result_capital_after = second_letter.select {|item| item =~ /[A-Z]/}
